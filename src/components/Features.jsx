...
const Features = () => {
  ...
  useGSAP(() => {
    ...
    animateWithGsap(".g_text", {y: 0, opacity: 1, ease: 'power2.in', duration: 1})
  }, []);
  return (
                ...
                <div className="feature-text-container">
                    <div className="flex-1 flex-center">
                        <p className="feature-text g_text">
                            iPhone 15 Pro is {" "}
                            <span className="text-white">the first iPhone to feature an aerospace-grade titanium design,</span>using the same alloy that spacescraft use for missions to Mars.
                        </p>
                    </div>
                    <div className="flex-1 flex-center">
                    <p className="feature-text g_text">
                            Titanium has one of the best strength-to-wweight ratios of any metal, making these our {" "}
